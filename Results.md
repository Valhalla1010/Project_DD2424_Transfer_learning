# **Result for binary classification task:**
...
finetune:  unfreeze l=1, 2,3, 4

l = 1, unfreezing: \['layer4'] + fc
...
Test Accuracy (l=1) = 88.12%



l = 2, unfreezing: \['layer3', 'layer4'] + fc
...
Test Accuracy (l=2) = 87.90%



l = 3, unfreezing: \['layer2', 'layer3', 'layer4'] + fc
...
Training complete in 106m 31s  :-) 

Best Validation Accuracy= 92.39%

Test Accuracy (l=3) = 87.95%



l = 4, unfreezing: \['layer1', 'layer2', 'layer3', 'layer4'] + fc
...
Training complete in 112m 5s  :-) 

Best Validation Accuracy= 91.58%

Test Accuracy (l=4) = 87.49%
...
Best Validation Accuracy= 72.60%
...
Training Completed in 50m 56s  :-) 

Best Validation Accuracy= 91.76%

Test Accuracy = 84.52%

Macro F1 = 0.8425  Weighted F1 = 0.8436
...
Training Completed in 50m 43s  :-) 

Best Validation Accuracy= 87.55%

Test Accuracy = 83.59%

Macro F1 = 0.8326  Weighted F1 = 0.8333
...
Training Completed in 50m 49s  :-) 

Best Validation Accuracy= 90.84%

Test Accuracy = 82.69%

Macro F1 = 0.8222  Weighted F1 = 0.8229



Summary:

Imbalanced (no fix):  Test=84.52%  Macro F1=0.8425  Weighted F1=0.8436

Weighted CE:          Test=83.59%  Macro F1=0.8326  Weighted F1=0.8333

Oversampling:         Test=82.69%  Macro F1=0.8222  Weighted F1=0.8229
...
Fraction=1%  Augmentation=False  L2=False
...
Unfrozen layers : \['fc', 'layer3', 'layer4']

Train Loss      = 1.0082

Train Accuracy  = 91.89%

Valid Accuracy  = 16.03%
...
Unfrozen layers : \['fc', 'layer2', 'layer3', 'layer4']

Train Loss      = 0.3207

Train Accuracy  = 100.00%

Valid Accuracy  = 31.66%
...
Unfrozen layers : \['fc', 'layer1', 'layer2', 'layer3', 'layer4']

Train Loss      = 0.0919

Train Accuracy  = 100.00%

Valid Accuracy  = 36.55%
...
Valid Accuracy  = 37.91%



Training complete in 11m 30s  :-)

Best Validation Accuracy = 37.91%



Fraction=1%  Test Accuracy = 35.27%

Saved plot: gradual\_limited\_frac1\_noaug\_nol2.png



============================================================

Fraction=1%  Augmentation=True  L2=True
...
Valid Accuracy  = 42.66%



Training complete in 12m 15s  :-)

Best Validation Accuracy = 42.66%



Fraction=1%  Test Accuracy = 39.57%

Saved plot: gradual\_limited\_frac1\_aug\_l2.png



============================================================

Fraction=10%  Augmentation=False  L2=False
...
Fraction=10%  Test Accuracy = 76.56%

Saved plot: gradual\_limited\_frac10\_noaug\_nol2.png



============================================================

Fraction=10%  Augmentation=True  L2=True
...
Train Accuracy  = 25.85%

Valid Accuracy  = 31.79%
...
Fraction=10%  Test Accuracy = 79.12%

Saved plot: gradual\_limited\_frac10\_aug\_l2.png



============================================================

Fraction=100%  Augmentation=False  L2=False
...
Training complete in 83m 13s  :-)

Best Validation Accuracy = 92.26%



Fraction=100%  Test Accuracy = 89.02%

Saved plot: gradual\_limited\_frac100\_noaug\_nol2.png



============================================================

Fraction=100%  Augmentation=True  L2=True
...
Fraction=100%  Test Accuracy = 87.63%

Saved plot: gradual\_limited\_frac100\_aug\_l2.png



\--- Summary ---

Fraction      No Aug/L2     Aug+L2
...
Saved plot: gradual\_limited\_fraction\_results.png





Data\_fraction	Augmentation	L2	Test Acc	Time

100%			No	No	87.74%		54m 54s

100%			Yes	Yes	87.30%		66m 40s

10%			No	No	78.69%		18m 4s

10%			Yes	Yes	78.00%		19m 8s

1%			No	No	29.95%		11m 18

1%			Yes	Yes	31.23%		12m 12s
